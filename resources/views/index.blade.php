                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-7">
                        <div class="welcome-intro">
                            ...
                            <p class="text-white-50 my-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                Impedit nihil tenetur minus quidem est deserunt molestias accusamus harum ullam tempore
                                debitis et, expedita, repellat delectus aspernatur neque itaque qui quod.</p>
                            <!-- Buttons -->
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-10 col-lg-7">
                        ...
                        <div class="section-heading text-center">
                            ...
                            <p class="text-white-50 d-none d-sm-block mt-4">Lorem ipsum dolor sit amet, consectetur
                                adipisicing elit. Laborum obcaecati dignissimos quae quo ad iste ipsum officiis deleniti
                                asperiores sit.</p>
                            <p class="text-white-50 d-block d-sm-none mt-4">Lorem ipsum dolor sit amet, consectetur
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <div class="single-service media p-3">
                            ...
                            <div class="media-body ml-4">
                                ...
                                <p class="text-white-50 mt-2 mb-3">Lorem ipsum dolor sit amet, consectet ur adipisicing
                                    elit, sed do eiusmod tempor incididunt emit.</p>
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="content-inner text-center">
                            ...
                            <div class="section-heading text-center mb-3">
                                ...
                                <p class="text-white-50 d-none d-sm-block mt-4">Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit. Laborum obcaecati dignissimos quae quo ad iste ipsum officiis
                                    deleniti asperiores sit.</p>
                                <p class="text-white-50 d-block d-sm-none mt-4">Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit. Laborum obcaecati.</p>
                            </div>
                            <!-- Content List -->
                        ...
                        <div class="row price-plan-wrapper">
                            ...
                            <div class="col-12 col-md-6 mt-4 mt-md-0">
                                ...
                                <div
                                    ...
                                    <!-- Plan Title -->
                                    <div class="plan-title mb-2 mb-sm-3">
                                        <h3 class="text-white mb-2">Pro <sup><span
                                                    class="badge badge-pill badge-warning ml-2">Save 20%</span></sup>
                                        </h3>
                                        <p class="text-white-50">Lorem ipsum dolor sit amet, consectetur adipisicing
                                            elit. Amet, nemo.</p>
                                    </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                            ...
                            <div class="footer-items">
                                ...
                                <ul class="social-icons list-inline pt-2">
                                    <li class="list-inline-item px-1"><a class="text-white-50" href="#"><i
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div
                                ...
                                <!-- Copyright Right -->
                                <div class="copyright-right text-white-50">Made with <i
                                        class="fas fa-heart color-2"></i> By <a class="text-white-50"
